  ...
  template: `
    <div class="power-balance-container" *ngIf="analysis">
      ...
      <p class="mat-caption balance-description">
        Power balance shows how evenly you distribute pedaling force between your left and right legs.
        A perfectly balanced rider produces 50% from each leg. Minor imbalances (up to ~3%) are normal
        and often vary with intensity, fatigue, and terrain. Consistent asymmetries above 55/45 may
        warrant a bike fit assessment or physiotherapy consultation.
      </p>
    ...
    <div class="power-balance-unavailable" *ngIf="!analysis && showUnavailable">
      <div fxLayout="column" fxLayoutAlign="center center" fxLayoutGap="8px">
        ...
        <p class="mat-caption" style="max-width: 540px; text-align: center; opacity: 0.6;">
          Balance data is recorded by dual-sided power meters (e.g., dual-sided pedals or cranks)
          and also by some spider-based or crank-based meters whose firmware calculates it.
          If your power meter supports balance, ensure the FIT file includes it and re-sync the activity.
        </p>
      </div>
    </div>
  `,
